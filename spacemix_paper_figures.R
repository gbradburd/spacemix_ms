...
load("~/Desktop/Dropbox/space.mix/data/warblers/warbler_spacemix/pop/warbler_pop_spaceruns/real_prior1/warbler_pop_dataset.Robj")
	...
	legend.pop.cols <- unique(pop.col[pop.order])
	subspp <- c("Nitidus","Viridanus","Ludlowi","Trochiloides","Obscuratus","Plumbeitarsus")

################
#	Sampling Map
################
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/warbler_sampling_map.pdf",width=6,height=4)
	#quartz(width=6,height=4)
		par(mar=c(3,3,1,1))
		plot(warbler.pop.coords,type='n',xlim=c(40,120),ylim=c(23,62))
			map(database="world",add=TRUE,col="gray")
			text(warbler.pop.coords,col=pop.col,labels=pops,font=2,cex=1.2)
			legend(x="bottomleft",col=legend.pop.cols,pch=19,
					legend=subspp,cex=0.9,bg="white")
		box(lwd=2)
	dev.off()
...
pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/warb_pop_PC_map.pdf",width=5,height=4)
	...
	text(proc.pc.coords,col=pop.col,labels=pops,cex=0.7,font=2)
			legend(x="bottomleft",col=legend.pop.cols,pch=19,
					legend=subspp,cex=0.75,bg="white")
	box(lwd=2)
dev.off()
...
load("~/Desktop/Dropbox/space.mix/data/warblers/warbler_spacemix/pop/warbler_pop_spaceruns/warb_pop_no_admixture/rand_prior1/warb_pop_spaceruns_NoAd_randpr1_LongRun/warb_pop_spaceruns_NoAd_randpr1space_MCMC_output1.Robj")
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/warb_pop_noad.pdf",width=7,height=5,pointsize=9)
	plot.spacemix.output.map(input.file = "~/Desktop/Dropbox/space.mix/data/warblers/warbler_spacemix/pop/warbler_pop_spaceruns/warb_pop_no_admixture/rand_prior1/warb_pop_spaceruns_NoAd_randpr1_LongRun/warb_pop_spaceruns_NoAd_randpr1space_MCMC_output1.Robj",
							 obs.coords = warbler.pop.coords,
							 sample.labels = pops,
							 colors = pop.col,
							 pdf.file.name="~/Desktop/Dropbox/space.mix/ms/figs/warblers/warb_pop_noad.pdf",
							 pdf.width = 7,
							 pdf.height = 5,
							 admixture=FALSE,xlim=NULL,ylim=NULL,pdf=FALSE)
		legend(x="bottomleft",col=legend.pop.cols,pch=19,
...
load("~/Desktop/Dropbox/space.mix/data/warblers/warbler_spacemix/pop/warbler_pop_spaceruns/real_prior1/warb_pop_spaceruns_realpr1_LongRun/warb_pop_spaceruns_realpr1space_MCMC_output1.Robj")
	...
	pop.order <- c(22,1,3:5,6:21,2)
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/warb_pop_Ad_nugget_realpr1.pdf",width=7,height=5)
		#quartz(width=7,height=5)
		plot(rowMeans(nugget)[pop.order],type='n',pch=19,ylim=c(-0.3,max(unlist(warb.pop.nugg.cred.sets))),
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/population_warbler_map_realpr1.pdf",width=7,height=5,pointsize=9)
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/population_warbler_admix_values_nugget_realpr1.pdf",width=4.5,height=5,pointsize=9)
...
load("~/Desktop/Dropbox/space.mix/data/warblers/warbler_spacemix/pop/warbler_pop_spaceruns/real_prior2/warb_pop_spaceruns_realpr2_LongRun/warb_pop_spaceruns_realpr2space_MCMC_output1.Robj")
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/population_warbler_map_realpr2.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
			plot(target.coords,type='n',
	...
	# pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/population_warbler_map_no_arrows_realpr2.png",res=300,width=7*300,height=5*300,pointsize=9)
		# #quartz(width=7,height=5,pointsize=9)
			# plot(target.coords,type='n',
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/population_warbler_admix_values_nugget_realpr2.pdf",width=4.5,height=5,pointsize=9)
		#quartz(width=5,height=5,pointsize=9)
		order <- c(1,3:15,2,16:22)
		par(mfrow=c(2,1),mar=c(1,4,0,1),oma=c(1,1,1,1))
			plot(admix.proportions[order,best]/2,type='n',
...
################
#	Admixture - RandPrior1
################
plot.spacemix.output.map(input.file="~/Desktop/Dropbox/space.mix/data/warblers/warbler_spacemix/pop/warbler_pop_spaceruns/rand_prior1/warb_pop_spaceruns_randpr1_LongRun/warb_pop_spaceruns_randpr1space_MCMC_output1.Robj",
						 obs.coords=warbler.pop.coords,
						 sample.labels=pops,
						 colors=pop.col,
						 pdf.file.name="~/Desktop/population_warbler_ad_map_randpr1.pdf",
						 pdf.width=7,
						 pdf.height=5,
						 xlim=c(71,114),
						 ylim=c(20,55))
...
best <- which.max(Prob)
	...
	par(mar=c(4.5,4.5,3,1))
	plot(target.coords,type='n',
			xlab="Eastings",ylab="Northings",cex.lab=1.7)
		text(target.coords,
				labels=plot.inds,
				col=inds.col,
				font=2)
...
best <- which.max(Prob)
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/individual_warbler_map_arrows_randpr2.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(4.5,4.5,3,1))
			plot(target.coords,type='n',
					xlim=c(min(target.coords[,1],source.coords[,1]),
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/warblers/individual_warbler_map_arrows_randpr2_closeup.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(4.5,4.5,3,1))
			plot(target.coords,type='n',
					xlim=c(75,102),
...
#					text.col = c("forestgreen","blue","purple","red","brown","orange"),cex=0.8)
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_world_map_text.pdf",width=9,height=5.5)
	#quartz(width=9,height=5.5)
	map("world",interior=FALSE,lwd=0.5,ylim=c(-60,85),xlim=c(-130,180),col="gray")
		box(lwd=2)
...
#					text.col = c("forestgreen","blue","purple","red","brown","orange"),cex=0.8)
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_NoAd_nugget.pdf",width=10,height=5)
		...
		plot(rowMeans(nugget)[pop.order],ylim=c(-0.08,max(unlist(globe.nugg.cred.sets))),
			...
			mtext("Population",side=1,padj=1)
			make.cred.bars(globe.nugg.cred.sets,0.8,color.vector= continent.col,vert.line.width=1.3,pop.order=pop.order)
	dev.off()
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_NoAd_map.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
...
#					text.col = c("forestgreen","blue","purple","red","brown","orange"))
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_Eurasia_NoAd_map_indproc.pdf",width=7,height=5,pointsize=9)
		par(mar=c(5.1, 5.1, 4.1, 2.1))
		#quartz(width=7,height=5,pointsize=9)
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_NoAd_dist_compare.pdf",height=5,width=12)
		#quartz(height=5,width=12)
		par(mfrow=c(1,2),mar=c(5,5,2,2))
		plot(obs.D,par.D,col="gray",pch=20,
#			xlim=c(0,5500),ylim=c(0,4500),
			ylab="geographic distance",
			xlab="geogenetic distance",cex=0.7,cex.lab=1.7)
		...
		plot(obs.D,par.D,col="gray",pch=20,
			xlim=c(0,5500),ylim=c(0,4500),
			ylab="",
			xlab="geographic distance",cex=0.7,cex.lab=1.7)
			for(i in 1:length(clusters)){
				use.these <- clusters[[i]]
				points(obs.D[use.these,use.these],par.D[use.these,use.these],col=1,pch=20,cex=0.73)
				points(obs.D[use.these,use.these],par.D[use.these,use.these],col=cluster.cols[i],pch=20,cex=0.7)
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_NoAd_dist_decay.pdf",height=5,width=12)
		#quartz(height=5,width=12)
		par(mfrow=c(1,2),mar=c(5,5,2,2))
		plot(obs.D,par.D,col="gray",pch=20,
#			xlim=c(0,5500),ylim=c(0,4500),
			ylab="geogenetic distance",
			xlab="geographic distance",cex=0.7,cex.lab=1.4)
			for(i in 1:length(clusters)){
				use.these <- clusters[[i]]
		...
		plot(mean.dist.from.africa,line.coeffs,col=cluster.cols,pch=19,cex=3,
			ylab="slope of geographic vs.\ngeogenetic distance",
			xlab="geographic distance from Africa",cex.lab=1.2)
...
save(globe_ad_obj,file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_Ad_object.Robj")
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_adprop.pdf",width=10,height=5)
		...
		plot(rowMeans(admix.proportions/2)[pop.order],ylim=c(-0.15,max(unlist(globe.adprop.cred.sets))/2),
			...
			text((1:k)+0.5,rep(-0.01,k),labels=pops[pop.order],srt=90,col=continent.col[pop.order],cex=0.65,adj=c(1,0))
			mtext("Population",side=1,padj=1)
			make.cred.bars(lapply(globe.adprop.cred.sets,'/',2),0.8,color.vector= continent.col[pop.order],vert.line.width=1.3)
			box(lwd=2)
	dev.off()

	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_Ad_map.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
		par(mar=c(5,5,4,2))
			plot(target.coords,type='n',
					xlim = c(18,68),
...
#					text.font = c(rep(1,6),2,3),family=c())
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_Ad_map_AfricaInset.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(5,5,4,2))
			plot(target.coords,type='n',
					xlim = c(15,68),
...
#					text.font = c(rep(1,6),2,3))
	...
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/eurasia_Ad_map_indproc.pdf",width=7,height=5,pointsize=9)#,pointsize=9
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(5,5,4,2))
			plot(eurasia.target.coords,type='n',
					yaxt='n',
...
load("~/Desktop/Dropbox/space.mix/data/globetrotter/globe_spacemix/globe_spaceruns/real_prior3/globe_spaceruns_realpr3_LongRun/globe_spaceruns_realpr3space_MCMC_output1.Robj")
	...
	x.subplot2 <- c(15,32.5)
	y.subplot2 <- c(25.5,44)
	subplot1.x.coords <- c(-4,25)
	subplot1.y.coords <- c(-15,6)
	subplot2.x.coords <- c(-165,180)
	subplot2.y.coords <- c(-60,80)


	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_Ad_map_AfricaInset_realpr3.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(5,5,4,2))
			plot(target.coords,type='n',
					xlim = c(-10,100),
	...
	x.min <- -10	#min(eurasia.target.coords[,1], eurasia.source.coords[,1]) - 5
	x.max <- 125		#max(eurasia.target.coords[,1], eurasia.source.coords[,1]) + 5
	y.min <- 10		#min(eurasia.target.coords[,2], eurasia.source.coords[,2]) - 5
	y.max <- 60		#max(eurasia.target.coords[,2], eurasia.source.coords[,2]) + 5
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/eurasia_Ad_map_indproc_realpr3.pdf",width=7,height=5,pointsize=9)#,pointsize=9
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(5,5,4,2))
			plot(eurasia.target.coords,type='n',
					yaxt='n',
...
load("~/Desktop/Dropbox/space.mix/data/globetrotter/globe_spacemix/globe_spaceruns/real_prior2/globe_spaceruns_realpr2_LongRun/globe_spaceruns_realpr2space_MCMC_output1.Robj")
	...
	x.subplot1 <- c(37,65)
	y.subplot1 <- c(-18,10.5)
	x.subplot2 <- c(15,32.5)
	y.subplot2 <- c(25.5,44)
	subplot1.x.coords <- c(5,18)
	subplot1.y.coords <- c(-15,0)
	subplot2.x.coords <- c(-165,180)
	subplot2.y.coords <- c(-60,80)


pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/globe_Ad_map_AfricaInset_realpr2.pdf",width=7,height=5,pointsize=9)
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(5,5,4,2))
			plot(target.coords,type='n',
					xlim = c(0,70),
	...
	x.min <- -12	#min(eurasia.target.coords[,1], eurasia.source.coords[,1]) - 5
	x.max <- 125		#max(eurasia.target.coords[,1], eurasia.source.coords[,1]) + 5
	y.min <- 0		#min(eurasia.target.coords[,2], eurasia.source.coords[,2]) - 5
	y.max <- 60		#max(eurasia.target.coords[,2], eurasia.source.coords[,2]) + 5
	pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/globetrotter/eurasia_Ad_map_indproc_realpr2.pdf",width=7,height=5,pointsize=9)#,pointsize=9
		#quartz(width=7,height=5,pointsize=9)
			par(mar=c(5,5,4,2))
			plot(eurasia.target.coords,type='n',
					yaxt='n',
...
################
#	Uneven sampling figs
################

source("~/Desktop/Dropbox/space.mix/sims/spacemix_ms_sims.R")
source("~/Desktop/Dropbox/space.mix/ms/spacemix.viz.functions.R")

load("~/Desktop/Dropbox/space.mix/sims/uneven_sampling/lattice/cyol/lattice_subsamp_randpr_1_LongRun/lattice_subsamp_randpr_1_space_MCMC_output1.Robj")
load("~/Desktop/Dropbox/space.mix/sims/uneven_sampling/lattice/cyol/subsampled_lattice_dataset.Robj")
sub.samp.cols <- rainbow(6,start=4/6,end=6/6)[as.numeric(cut(subsampled.dataset$population.coordinates[,1],6))]
pop.names <- c(27,22,13,17,9,4,15,1,16,8,29,5)
map.list <- make.spacemix.map.list("~/Desktop/Dropbox/space.mix/sims/uneven_sampling/lattice/cyol/lattice_subsamp_randpr_1_LongRun/lattice_subsamp_randpr_1_space_MCMC_output1.Robj",
...
par(mfrow=c(1,3))
migration.rate.graphic(x.pops = 5,y.pops = 6,migration.rate=1,
						migration.arrows=FALSE,jitter=0.25,labels=TRUE,
						colors=TRUE,arrow.width=1,pop.pt.cex=2.5,pop.lab.cex=2.5)
plot(subsampled.dataset$population.coordinates,
		col=sub.samp.cols,
		pch=19,cex=5,
		xlab="",ylab="",
		xlim=c(0,12),ylim=c(0,10))
		text(subsampled.dataset$population.coordinates,
				labels=pop.names,
...
load("~/Desktop/Dropbox/space.mix/sims/uneven_sampling/barrier/cyol/subsampled_barrier_dataset.Robj")
sub.samp.cols <- rainbow(6,start=4/6,end=6/6)[as.numeric(cut(subsampled.dataset$population.coordinates[,1],6))]
pop.names <- c(14,5,30,17,21,24,25,27,3,18,2,19)
			#c(27,22,13,17,9,4,15,1,16,8,29,5)
map.list <- make.spacemix.map.list("~/Desktop/Dropbox/space.mix/sims/uneven_sampling/barrier/cyol/barrier_subsamp_randpr_1_LongRun/barrier_subsamp_randpr_1_space_MCMC_output1.Robj",
									observed.coords = subsampled.dataset$population.coordinates,
									name.vector =   pop.names,
									color.vector = sub.samp.cols)
									
pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/sims/uneven_sampling_barrier.pdf",height=4,width=12,pointsize=9)
# quartz(height=4,width=12)
par(mfrow=c(1,3))
migration.rate.graphic(x.pops = 5,y.pops = 6,migration.rate=1,
						migration.arrows=FALSE,jitter=0.25,labels=TRUE,
						colors=TRUE,arrow.width=1,pop.pt.cex=2.5,pop.lab.cex=2.5)
						abline(v=6.001,col="gray",lty=2,lwd=5)
plot(subsampled.dataset$population.coordinates,
		col=sub.samp.cols,
		pch=19,cex=5,
		xlab="",ylab="",
...
pdf(file="~/Desktop/Dropbox/space.mix/ms/figs/sims/example_acceptance_rates.pdf",width=12,height=5)
#quartz(width=12,height=5)
par(mfrow=c(1,2))
