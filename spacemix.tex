...
and in close to the correct amount ($\bar{w}_{(23)} = 0.05; 95\% \text{CI} = 0.02-0.08$). \gb{get new figs from phoebe}
...
which consists of 95 individuals sampled at 22 distinct locations and sequenced at 2,334 SNPs, of which 2,247 were bi-allelic and retained for SpaceMix runs.
...
and may be better suited to visualization with hierarchical clustering-based methods or TreeMix.  
