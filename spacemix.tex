...
An obvious concern is the identifability of all of these parameters, most notability whether population locations, admixture locations and proportions can be estimated. If a population has received some level of admixture from a another population what is to stop it simply moving towards that population to in geogenetic space to satisfy its increased resemblance to that population, rather than choosing admixture from that location. 
\begin{equation}
...
We use a Bayesian approach to parameter inference, and specify priors on all parameters.
