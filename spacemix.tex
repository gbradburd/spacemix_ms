...
even those the admixture events may have occurred many generations ago.
...
and subsequently exchange migrants.
...
Since allowing $T$ to very by locus would be computationally infeasible,
...
\begin{figure}[htp!]
    ...
    Dots above `B' show the covariances observed with B at that location if B has 40\% admixture from D;
    note that there is no single spatial location with unadmixed covariances remotely similar to these.
