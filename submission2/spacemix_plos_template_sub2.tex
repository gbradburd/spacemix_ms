...
PCA is an extremely helpful method for visualization of high-dimensional data used in exploratory data analysis \citep{tukey1977exploratory}.
...
or other genealogical distortions \citep{mcvean2009genealogical} 
...
the resulting PC axes display a combination of between-population and within-population structure, resulting in the typical triangular shape of many PC plots.  
...
{\bf{Fig.\ \ref{sfig:uneven_sampling}. The effect of uneven sampling on inference of geogenetic maps.}}
