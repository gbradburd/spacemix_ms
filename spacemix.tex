...
that visualizes how populations are located with respect to one another under isolation by distance, 
modeling allele frequency covariance as a decreasing function of geogenetic distance. 
Within this framework, we look for historical admixture (gene flow over unusually long geogenetic distances) 
by identifying anomalously long distance allele frequency covariance, 
and model admixture as arrows, from a source of admixture to its recipient, on the inferred map.
...
To produce geogenetic maps, we take the maximum a posteriori estimates (over all parameters).
