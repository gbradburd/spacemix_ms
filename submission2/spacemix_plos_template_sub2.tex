...
PCA is an extremely helpful method for visualization of high-dimensional data used in exploratory data analysis \cite{Tukey1977}.
...
However, other factors such as genome rearrangements \cite{ma2012investigation} 
or other genealogical distortions \cite{mcvean_genealogical_2009} 
...
\bibitem[Ma and Amos (2012)]{ma2012investigation}
J~Ma and C~I Amos.
\newblock Investigation of inversion polymorphisms in the human genome using
  principal components analysis.
\newblock \emph{PLoS One}, 7\penalty0 (7), 2012.
