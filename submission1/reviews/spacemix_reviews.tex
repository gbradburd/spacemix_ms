...
- From a statistical point of view, perform a mapping $R^2$ -> $R^2$ based on a covariance matrix and variogram analysis is something that has been studied (2, 3). A connection between the present work and the statistical literature is interesting to place the work in a broader context of warping study.
