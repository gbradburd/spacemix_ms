...
\gb{This modeling approach rests on the assumption that the loci in the dataset are independent, that is, not in linkage disequilibrium (LD).
...
\gb{The axes of the resultant maps are presented as Northings and Eastings, 
...
\gb{In all scenarios, populations at the corners of the lattice are pulled in somewhat
...
\gb{As with the simulations described above, the axes of the geogenetic maps are presented
...
\gb{In this paper, we have treated the loci in the dataset as independent, and,
