...
\end{equation}
where $f_{\ell,k}$ are the model-estimated allele frequencies across loci at the spatial location of population $G_k$ and $f_{\ell,k*}$ are the model-estimated allele frequencies at the spatial location of the source of admixture $G_{k*}$. We can allow each of our populations to have this setup, each with an independent spatial source of admixture. 
