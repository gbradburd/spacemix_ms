...
%Our method shows the utility of representing both Isolation by Distance and long-distance admixture on a 2-D geogenetic map.  While we perform inference of this map using likelihood-based inference relating a parametric covariance matrix to the observed empirical matrix, it would be interesting to explore other methods of generating this geogenetic map (e.g., warping, cite their stuff, SPA, EEMS).  Such methods may offer computational speedups and also potentially help place SpaceMix within a broader statistical framework.
