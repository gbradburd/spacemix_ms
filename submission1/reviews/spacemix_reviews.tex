...
\gb{This is an excellent point.  We have now written much more detailed descriptions of the procedure we use for dealing with LD in our analyses of empirical data (Lines XX-XX), as well as possible method extensions to deal with LD (Lines XX-XX).}\\
