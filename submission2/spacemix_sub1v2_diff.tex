...
%DIF ADD /Users/gburd/Desktop/Dropbox/space.mix/ms/submission2/spacemix_plos_template_sub2.tex   Fri Aug 21 15:43:11 2015
...
and dividing by $\sqrt{\bar{f}_{\ell}(1-\bar{f}_{\ell})}$ makes each locus have roughly unit variance\DIFdelbegin \DIFdel{in some sense}\DIFdelend .
...
A null model inspired by models of LD under isolation by distance models \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Arkendra2007,Barton2013} }%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Arkendra20067,Barton2013} }%DIFAUXCMD
}\DIFaddend could be fitted, 
...
(2) populations \DIFdelbegin \DIFdel{may choose their own locations }\DIFdelend \DIFaddbegin \DIFadd{locations are estimated}\DIFaddend , but not admixture; 
(3) populations may draw admixture, but their own locations are fixed; or
(4) populations \DIFdelbegin \DIFdel{may both choose their own locations and draw admixture }\DIFdelend \DIFaddbegin \DIFadd{locations and admixture are both estimated}\DIFaddend .  
