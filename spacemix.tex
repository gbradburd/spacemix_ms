...
To accommodate these heterogeneous processes, and to have a useful data visualization tool, we can estimate treat population's locations on the landscape as a random variable, and estimate them as part of our inference procedure.  Rich history of this type of data visualization, especially w/r/t PCA (but see also SpA).
