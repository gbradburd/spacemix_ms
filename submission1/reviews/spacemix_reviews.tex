...
\par\gb{We can run TreeMix on the lattice dataset, and show that the results are (hopefully) weird.
	For PCA...not sure.  I have the 1D simulations, and I have the PCA for the global human dataset, which is not super map-like.
	Could also come back to that ``how much variance is explained in our map vs. PCA map?" comparison...}\\\\
%%%%%
...
\item Peter to think about quantifying the variance explained by our map
