...
\begin{figure}
	\centering
		\subcaptionbox{Warbler subspecies distribution map \label{irwin_map}}
			{\includegraphics[width=2.4in,height=2in]{Irwin_warbler_map_figure.png}}
		\subcaptionbox{Inferred admixture proportions and population nuggets \label{warb_pop_adnug}}			
			{\includegraphics[width=2.4in,height=2in]{population_warbler_admix_values_nugget.png}}
		\subcaptionbox{Map inferred using SpaceMix \label{warb_pop_no_arrows}}
			{\includegraphics[width=2.4in,height=2in]{population_warbler_map_no_arrows.png}}
		\subcaptionbox{Map inferred using SpaceMix with admixture arrows shown \label{warb_pop_arrows}}
			{\includegraphics[width=2.4in,height=2in]{population_warbler_map_randpr1.png}}
...
\begin{figure}
	\centering
		\subcaptionbox{\label{warb_pop_realpr1}}
			{\includegraphics[width=1.85in,height=1.54in]{population_warbler_map_realpr1.png}}
		\subcaptionbox{\label{warb_pop_realpr2}}			
			{\includegraphics[width=1.85in,height=1.54in]{population_warbler_map_realpr2.png}}
		\subcaptionbox{\label{warb_pop_randpr1}}
			{\includegraphics[width=1.85in,height=1.54in]{population_warbler_map_randpr1.png}}
...
%
make pop figures
highlight the nugget
explain diff parts of cov plot
talk through the biology
are those 2 guys sibs?
show populations
	-then add in admixture, highlighting the role of ST
show individuals
	make comparison w/ PCA, and note that PCA gets it right but for the wrong reasons
	 	show the linesim example
close w/ discussion of the "brokenness"
	-comparison of observed against parametric diet
	-try procrustes transfo w/out turkey, to see if distances are closer to observed.
	-highlight what falls off the line.
