...
modeling \gc{allele frequency} covariance as a decreasing function of geogenetic distance. 
...
\begin{figure}
	\centering
		\subcaptionbox{Inferred map of human populations \label{globe_all_noad_map}}
			{\includegraphics[width=0.45\textwidth,height=0.37\textwidth]{figs/globetrotter/globe_NoAd_map.pdf}}
		\subcaptionbox{Close-up of Eurasian populations \label{globe_eurasia_noad_map}}
			{\includegraphics[width=0.45\textwidth,height=0.37\textwidth]{figs/globetrotter/globe_Eurasia_NoAd_map_indproc.pdf}}
