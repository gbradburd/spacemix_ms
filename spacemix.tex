...
\gc{The greenish warbler (\emph{Phylloscopus trochiloides}) species complex is broadly distributed around the Tibetan plateau, and exhibits gradients around the ring in a range of phenotypes including song, as well allele frequencies (Ticehurst (1938),Irwin et al 2001, Irwin et al 2005, Irwin et al 2008).  At the northern end of the ring in central Siberia, where the eastern and western arms of population expansion meet, there are discontinuities in call and other phenotypes, as well as a genetic discontinuity and reproductive isolation (Irwin et al 2001, Irwin et al 2008). It is proposed that the species complex represents a ring species, where selection and/or drift as the populations spread northward on either side of the Tibetan plateau has led to the evolution of reproductive isolation REFs.  The question of whether it constitutes a ring species, in purest form, focuses whether gene flow along the margins of the plateau has truly been continuous throughout the history of the expansion or if, alternatively, discontinuities in migration around the species complex's range have facilitated periods of differentiation in genotype or phenotype without gene flow (Mayr 1942, Mayr 1970, Coyne and Orr 2004).  However, we note that many would still classify this as a ring species even if that condition is not met, just not as a case of speciation-by-distance \citep[see][ for discussion]{}.  }


%The greenish warbler is thought to have spread northwards around the Tibetan plateau. 
\gc{Graham thinks that call is a phenotype.}
