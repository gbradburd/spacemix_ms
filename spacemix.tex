...
\begin{figure}
	...
	\caption{Likelihood surfaces for different placements of population ST between \textit{plumbeitarsus} and \textit{viridanus} clusters: (a) log likelihood surface; (b) posterior probability surface, incorporating the priors. \gc{The maximum a posteriori estimate (MAP) is shown as a star.} }\label{sfig:admix_prop_func_loc}
\end{figure}
