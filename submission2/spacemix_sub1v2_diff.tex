...
%DIF ADD /Users/gburd/Desktop/Dropbox/space.mix/ms/submission2/spacemix_plos_template_sub2.tex   Thu Aug 13 14:11:41 2015
...
or, in the empirical analyses of human data, we have thinned the total dataset for LD in windows of 50 base-pairs, with a step-size of 5 base-pairs, and an upper limit of 0.2 on pairwise $r^2$ \mbox{%DIFAUXCMD
...
\DIFdelbegin \DIFdel{The libraries were prepared using a genotype-by-sequencing protocol and were run on an Illumina HiSeq 2000 with a paired-end sequencing protocol \mbox{%DIFAUXCMD
\cite{alcaide2014genomic}}%DIFAUXCMD
.
}\DIFdelend %DIF > The libraries were prepared using a genotype-by-sequencing protocol and were run on an Illumina HiSeq 2000 with a paired-end sequencing protocol \cite{alcaide2014genomic}.
...
We used a random subset of 10,000 SNPs \DIFaddbegin \gb{come back to this} \DIFaddend from the dataset of Hellenthal \emph{et al.}\cite{Hellenthal}, 
